...
namespace CALKU.Data
{//for the second semester
    public class DatabaseContextSem2 : IAsyncDisposable
    {
        private const string DbName = "CalkuDatabase2.db3";
        ...
        {
            await CreateTableIfNotExists<TTable>();
            //used in the next methotds-delete,add,get,update
            return await action();
        }
